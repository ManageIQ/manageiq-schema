class AddAncestryToResourcePool < ActiveRecord::Migration[5.2]
  ...
  class Relationship < ActiveRecord::Base
    belongs_to :resource_pool, :class_name => 'AddAncestryToResourcePool::ResourcePool'
  end
  ...
  def up
    ...
    say_with_time("set ResourcePool ancestry from existing genealogy relationship resource information") do
  ...
  def down
    say_with_time("create relationship records from ResourcePool ancestry") do
  ...
  # src is relationship, dest is ResourcePool
  ...
  # src is ResourcePool, dest is relationship
